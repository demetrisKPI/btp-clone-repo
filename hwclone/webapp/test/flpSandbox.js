		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Clone repo App Title",
									"targetURL": "#sapbtphwclone-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtphwclone-display": {
								"semanticObject": "sapbtphwclone",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.hwclone",
									"url": sap.ui.require.toUrl("sap/btp/hwclone")
								}
							}
						}
					}
